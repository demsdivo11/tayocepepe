...
namespace gnettokenServer {
    ...
    {
        PACKET_FLAGS_FLYING = 1 << 1,
        PACKET_FLAGS_UPDATE = 1 << 2,
        PACKET_FLAGS_EXTENDED = 1 << 3,
        PACKET_FLAGS_FACINGLEFT = 1 << 4,
        PACKET_FLAGS_ONGROUND = 1 << 5,
        PACKET_FLAGS_LAVA = 1 << 6,
        PACKET_FLAGS_JUMPSOUND = 1 << 7,
        PACKET_FLAGS_DEATH = 1 << 8,
        PACKET_FLAGS_PUNCH = 1 << 9,
        PACKET_FLAGS_PLACE = 1 << 10,
        PACKET_FLAGS_TILEACTION = 1 << 11,
        PACKET_FLAGS_KNOCKBACK = 1 << 12,
        PACKET_FLAGS_RESPAWN = 1 << 13,
        PACKET_FLAGS_PICKUPSOUND = 1 << 14,
        PACKET_FLAGS_TRAMPOLINE = 1 << 15,
        PACKET_FLAGS_CACTUS = 1 << 16,
        PACKET_FLAGS_SLIDING = 1 << 17,
        PACKET_FLAGS_JUMPPEAK = 1 << 18,
        PACKET_FLAGS_FALLING_SLOWLY = 1 << 19,
        PACKET_FLAGS_SWIM_SOUND = 1 << 20,
        PACKET_FLAGS_WALLHANG = 1 << 21,
        PACKET_FLAGS_RAYMAN_START = 1 << 22,
        PACKET_FLAGS_RAYMAN_END = 1 << 23,
        PACKET_FLAGS_RAYMAN_LOAD = 1 << 24,
        PACKET_FLAGS_FORCE_RING = 1 << 25,
        PACKET_FLAGS_CACTUS_RAPE = 1 << 26,
        PACKET_FLAGS_ACID = 1 << 28
    };
...
#pragma pack(push, 1)
    struct gameupdatepacket_t
    {
        ...
        void set_int_x(uint32_t val) {
            m_int_x = val;
        }
        void set_int_y(uint32_t val) {
            m_int_y = val;
        }
    };
#pragma pack(pop)
